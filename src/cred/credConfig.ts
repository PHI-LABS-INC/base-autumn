...
export const credConfig: { [key: number]: CredConfig } = {
  ...
  72: {
    ...baseSettings,
    network: 1,
    title: 'Joined the Prima faction',
    requirement: 'Minted an avatar of Prima faction',
    credType: 'BASIC',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 13,
    project: 'PHI',
    tags: ['PHI', 'Wawa', 'Prima'],
    relatedLinks: ['https://wawa.philand.xyz/'],
  },
  73: {
    ...baseSettings,
    network: 1,
    title: 'Joined the Zook faction',
    requirement: 'Minted an avatar of Zook faction',
    credType: 'BASIC',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 14,
  ...
  74: {
    ...baseSettings,
    network: 1,
    title: 'Joined the Mecha faction',
    requirement: 'Minted an avatar of Mecha faction',
    credType: 'ADVANCED',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 15,
  ...
  75: {
    ...baseSettings,
    network: 1,
    title: 'Joined the Flavo faction',
    requirement: 'Minted an avatar of Flavo faction',
    credType: 'ADVANCED',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 16,
  ...
  76: {
    ...baseSettings,
    title: 'PHI Token Holder',
    requirement: 'Hold PHI tokens on Base',
    credType: 'BASIC',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 17,
  ...
  77: {
    ...baseSettings,
    title: 'stPhi Token Holder',
    requirement: 'Hold stPhi tokens on Base',
    credType: 'BASIC',
    verificationType: 'SIGNATURE',
    apiChoice: 'adhoc',
    id: 18,
